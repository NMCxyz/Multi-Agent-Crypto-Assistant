...
class CryptoFinancialDocParser:
    """
    Handles parsing of crypto/financial research documents using docling.
    """
    def __init__(self):
        self.logger = logging.getLogger(__name__)
        self.logger.info("Crypto/Financial Document Parser initialized!")
